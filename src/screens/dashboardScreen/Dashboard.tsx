    ...
    datasets: [
      {
        label: "Poll",
        data: [6, 35, 15, 4, 8, 10],
        backgroundColor: ["#81C784", "#07AF0E", "#C8E6C9", "#4CAF50"],
        borderColor: ["#81C784", "#07AF0E", "#C8E6C9", "#4CAF50"],
        borderWidth: 2,
        borderRadius: 7,
        offset: 30,
      },
  ...
  return (
    <div className="w-full dashboard">
      <div className="w-full">
        <div
          className={`flex flex-col lg:flex-row items-center justify-between ${styles.firstRow}`}
        >
          <div className="lg:w-1/2">
            ...
            <p className="text-subTXTColor montserrat-font font-thin mb-3">
          ...
          <div className="lg:w-1/2">
            <div className="flex justify-center p-5 gap-24">
              ...
              <div className={`${styles.doughnutContainer} lg:ml-auto`}>
            ...
            <div className="mb-10 w-2/5 bg-white rounded-lg p-7">
              <div>
                ...
                <GaugeChart
                  ...
                  hideText={true}
                  needleColor="#FF7A00"
                  needleBaseColor="#FF7A00"
                />
                <p
                  className="montserrat_gray text-center"
                  style={{ fontSize: "18px" }}
                >
                  Your Point: <span className={styles.points}>8.966</span>
                </p>
              </div>
            </div>
          </div>
          <div className="flex gap-5">
            <div className=" flex justify-between flex-grow bg-white rounded-lg p-7">
              <div className="w-full">
                <h3>Task Progress</h3>
